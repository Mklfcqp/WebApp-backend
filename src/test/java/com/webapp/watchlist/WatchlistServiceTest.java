...
class WatchlistServiceTest {
    ...
    public void addWatchlistDataManualTest() {
        ...
        request.setPrice(BigDecimal.valueOf(152.51));
        request.setCurrencyPrice("USD");
        request.setDcfWithMarginOfSafety(BigDecimal.valueOf(100));
        request.setCurrencyDcf("USD");
        request.setDividendQ(BigDecimal.valueOf(1.5));
        request.setCurrencyDividendQ("USD");
        request.setCurrencyDividendY("USD");
        ...
        assertEquals("Apple Inc.", watchlists.get(0).getCompany());
